...
import { formatMovingTime, calculatePace, formatDate } from "@/lib/utils";
import { Skeleton } from "@/components/ui/skeleton";
import { Alert, AlertDescription, AlertTitle } from "@/components/ui/alert";
import { useToast } from "@/components/ui/use-toast";

// Import your new hooks here (adjust the path based on your folder structure)
import { useGetActivity, useExportToToon } from "@/hooks/use-strava";
...
export default function ActivityPage() {
    ...
    const handleExport = async () => {
        try {
            ...
            const blobContent = typeof toonData === 'string' ? toonData : JSON.stringify(toonData);
            ...
            <div className="p-4">
                ...
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <Card>
                        ...
                        </CardHeader> {/* Fixed the </Header> typo from original code here */}
                        <CardContent>
    ...
    return (
        <div className="p-4">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                ...
                <Card>
                    <CardHeader>
                        <CardTitle>Device & Gear</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <p>
                            <strong>Device:</strong> {activity.device_name}
                        </p>
                        {activity.gear_id && (
                            <p>
                                <strong>Gear:</strong> {activity.gear_id}
                            </p>
                        )}
                    </CardContent>
                </Card>
